...
def boosted_trees_bucketize(float_values, bucket_boundaries, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        bucket_boundaries=bucket_boundaries, name=name)
    _result = _op.outputs[:]
...
def boosted_trees_create_quantile_stream_resource(quantile_stream_resource_handle, epsilon, num_streams, max_elements=1099511627776, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        quantile_stream_resource_handle=quantile_stream_resource_handle,
        epsilon=epsilon, num_streams=num_streams, max_elements=max_elements,
        name=name)
    return _op
    _result = None
    return _result
...
def boosted_trees_quantile_stream_resource_flush(quantile_stream_resource_handle, num_buckets, generate_quantiles=False, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        quantile_stream_resource_handle=quantile_stream_resource_handle,
        num_buckets=num_buckets, generate_quantiles=generate_quantiles,
        name=name)
    return _op
    _result = None
    return _result
