...
@tf_export('io.decode_compressed', 'decode_compressed')
...
@tf_export('io.decode_json_example', 'decode_json_example')
...
@tf_export('io.decode_raw', 'decode_raw')
...
@tf_export('io.parse_tensor', 'parse_tensor')
...
@tf_export('strings.to_number', 'string_to_number')
@deprecated_endpoints('string_to_number')
