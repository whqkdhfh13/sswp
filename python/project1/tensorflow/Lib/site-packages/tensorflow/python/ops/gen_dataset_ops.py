...
def map_dataset(input_dataset, other_arguments, f, output_types, output_shapes, use_inter_op_parallelism=True, name=None):
  r"""Creates a dataset that applies `f` to the outputs of `input_dataset`.
...
def map_dataset_eager_fallback(input_dataset, other_arguments, f, output_types, output_shapes, use_inter_op_parallelism=True, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def map_defun(arguments, output_types, output_shapes, f, name=None):
  r"""  Maps a function on the list of tensors unpacked from inputs on dimension 0.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    output_shapes = [_execute.make_shape(_s, "output_shapes") for _s in output_shapes]
    _, _, _op = _op_def_lib._apply_op_helper(
        "MapDefun", arguments=arguments, output_types=output_types,
        output_shapes=output_shapes, f=f, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("Targuments", _op.get_attr("Targuments"), "output_types",
              _op.get_attr("output_types"), "output_shapes",
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, arguments, "output_types",
        output_types, "output_shapes", output_shapes, "f", f)
      return _result
    except _core._FallbackException:
      return map_defun_eager_fallback(
          arguments, output_types=output_types, output_shapes=output_shapes,
...
def map_defun_eager_fallback(arguments, output_types, output_shapes, f, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  ...
  _inputs_flat = list(arguments)
  _attrs = ("Targuments", _attr_Targuments, "output_types", output_types,
...
def multi_device_iterator_get_next_from_shard(multi_device_iterator, shard_num, incarnation_id, output_types, output_shapes, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        multi_device_iterator=multi_device_iterator, shard_num=shard_num,
        incarnation_id=incarnation_id, output_types=output_types,
        output_shapes=output_shapes, name=name)
    _result = _op.outputs[:]
    if not _result:
      return _op
...
def multi_device_iterator_to_string_handle(multi_device_iterator, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        multi_device_iterator=multi_device_iterator, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = None
    _execute.record_gradient(
...
def optimize_dataset(input_dataset, optimizations, output_types, output_shapes, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        optimizations=optimizations, output_types=output_types,
        output_shapes=output_shapes, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("output_types", _op.get_attr("output_types"), "output_shapes",
...
def parallel_interleave_dataset_v2(input_dataset, other_arguments, cycle_length, block_length, num_parallel_calls, f, output_types, output_shapes, name=None):
  r"""Creates a dataset that applies `f` to the outputs of `input_dataset`.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        other_arguments=other_arguments, cycle_length=cycle_length,
        block_length=block_length, num_parallel_calls=num_parallel_calls, f=f,
        output_types=output_types, output_shapes=output_shapes, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("f", _op.get_attr("f"), "Targuments",
...
def parallel_interleave_dataset_v2_eager_fallback(input_dataset, other_arguments, cycle_length, block_length, num_parallel_calls, f, output_types, output_shapes, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def parallel_map_dataset(input_dataset, other_arguments, num_parallel_calls, f, output_types, output_shapes, use_inter_op_parallelism=True, name=None):
  r"""Creates a dataset that applies `f` to the outputs of `input_dataset`.
...
def parallel_map_dataset_eager_fallback(input_dataset, other_arguments, num_parallel_calls, f, output_types, output_shapes, use_inter_op_parallelism=True, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def parse_example_dataset(input_dataset, num_parallel_calls, dense_defaults, sparse_keys, dense_keys, sparse_types, dense_shapes, output_types, output_shapes, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        num_parallel_calls=num_parallel_calls, dense_defaults=dense_defaults,
...
def parse_example_dataset_eager_fallback(input_dataset, num_parallel_calls, dense_defaults, sparse_keys, dense_keys, sparse_types, dense_shapes, output_types, output_shapes, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def set_stats_aggregator_dataset(input_dataset, stats_aggregator, output_types, output_shapes, name=None):
  r"""TODO: add doc.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        stats_aggregator=stats_aggregator, output_types=output_types,
        output_shapes=output_shapes, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("output_types", _op.get_attr("output_types"), "output_shapes",
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        input_dataset, stats_aggregator, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
...
def set_stats_aggregator_dataset_eager_fallback(input_dataset, stats_aggregator, output_types, output_shapes, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  ...
  _inputs_flat = [input_dataset, stats_aggregator]
  _attrs = ("output_types", output_types, "output_shapes", output_shapes)
...
def sink_dataset(input_dataset, name=None):
  r"""A placeholder for input pipeline graph optimizations.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    _, _, _op = _op_def_lib._apply_op_helper(
        "SinkDataset", input_dataset=input_dataset, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = None
    _execute.record_gradient(
      "SinkDataset", _inputs_flat, _attrs, _result, name)
    _result, = _result
    return _result
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._eager_context.device_name, "SinkDataset",
        name, _ctx._post_execution_callbacks, input_dataset)
      return _result
    except _core._FallbackException:
      return sink_dataset_eager_fallback(
          input_dataset, name=name, ctx=_ctx)
    except _core._NotOkStatusException as e:
      if name is not None:
        message = e.message + " name: " + name
...
def sink_dataset_eager_fallback(input_dataset, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  ...
  _inputs_flat = [input_dataset]
  _attrs = None
  _result = _execute.execute(b"SinkDataset", 1, inputs=_inputs_flat,
                             attrs=_attrs, ctx=_ctx, name=name)
  _execute.record_gradient(
      "SinkDataset", _inputs_flat, _attrs, _result, name)
  _result, = _result
...
def slide_dataset(input_dataset, window_size, window_shift, window_stride, output_types, output_shapes, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        window_shift=window_shift, window_stride=window_stride,
        output_types=output_types, output_shapes=output_shapes, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("output_types", _op.get_attr("output_types"), "output_shapes",
...
def slide_dataset_eager_fallback(input_dataset, window_size, window_shift, window_stride, output_types, output_shapes, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
