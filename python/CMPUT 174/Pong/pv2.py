# Pong Version 2
# Add scores, and also balls now bounce off the paddles.
import pygame as pg
...
class Paddle:
    def __init__(self, coordinates, size, surface):
        ...
        self.rect = pg.Rect(self.location[0], self.location[1], self.size[0], self.size[1])

    def draw(self):  # Draw its object
        pg.draw.rect(self.surface, pg.Color('white'), self.rect)
...
class Game:
    def __init__(self, surface):
        ...
        self.ball = Ball([400, 300], 10, [3, 1], self.surface)
