...
class Game:
    def __init__(self, surface):
        ...
        self.main_array = [[x for x in range(4)]] * 4
        self.main_array2 = [[(y, x) for x in range(3)] for y in range(3)]
    ...
    def draw(self):
        ...
        self.surface.blit(self.font.render(str(self.main_array2), False, (255, 255, 255)), (0, 0))
...
def main():
    ...
    # MAIN GAME LOOP 
    Game(pg.display.set_mode((600, 600))).play()
